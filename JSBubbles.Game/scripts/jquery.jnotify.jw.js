 ...
 * Date: 2010-09-30
 * Rev:  1.2.00
 * 1.2 modified by Jarek Wasilewski
 * added:
 * - option to add messages area to any element of the page (default is still body),
 * - in non-sticky mode click on message dismiss it.
 */
;(function($){
